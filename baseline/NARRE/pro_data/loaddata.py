...
dill.dump(user_reviews, open(os.path.join(TPS_DIR, 'user_review'), 'wb'))
dill.dump(item_reviews, open(os.path.join(TPS_DIR, 'item_review'), 'wb'))
dill.dump(user_rid, open(os.path.join(TPS_DIR, 'user_rid'), 'wb'))
dill.dump(item_rid, open(os.path.join(TPS_DIR, 'item_rid'), 'wb'))
